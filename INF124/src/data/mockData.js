export const BUILDINGS = [
  ...
  },
  {
    ...
    description: 'State-of-the-art fitness and recreation facility for students, faculty, and staff.',
    departments: [],
    image: null,
  },
  {
  ...
  {
    id: 'mesa',
    name: 'Mesa Court Dining',
    abbr: 'MCD',
    category: 'Dining',
    lat: 33.6493,
    lng: -117.8442,
    hours: 'Mon–Fri 7am–9pm, Sat–Sun 9am–8pm',
    description: 'All-you-can-eat dining hall serving breakfast, lunch, and dinner.',
    departments: [],
    image: null,
  },
  {
    ...
    description: "UCI's flagship all-you-can-eat dining hall with a wide variety of options.",
    departments: [],
    image: null,
  },
  {
    id: 'sspa',
    name: 'Social Science Plaza A',
    abbr: 'SSPA',
    category: 'Academic',
    lat: 33.6479,
    lng: -117.8408,
    hours: 'Mon–Fri 8am–6pm',
    description: 'Houses Economics, Political Science, Sociology, and other social science departments.',
  ...
  },
  {
    ...
    description: 'Department of Chemistry and Biochemistry research and teaching facility.',
  ...
  },
  {
    ...
    lat: 33.6474,
    lng: -117.8432,
    hours: 'Mon–Fri 7:30am–10pm, Sat–Sun 9am–6pm',
    description: 'Hub for student life, featuring dining options, meeting rooms, and student services.',
    departments: [],
    image: null,
  },
  {
    ...
    lng: -117.8391,
    hours: '24/7',
    description: 'Multi-level parking structure near the Engineering zone.',
    departments: [],
    image: null,
  },
  {
    ...
    lng: -117.8426,
    hours: 'Always Open',
    description: 'Central park at the heart of UCI campus, perfect for studying or relaxing outdoors.',
    departments: [],
    image: null,
  },
  {
    ...
    lat: 33.6455,
    lng: -117.8409,
    hours: 'Mon–Thu 8am–10pm, Fri 8am–6pm, Sat–Sun 12pm–6pm',
    description: 'Science and engineering research library with study rooms and 3D printing resources.',
    departments: [],
    image: null,
  },
  {
    ...
    description: 'Home of the Samueli School of Engineering with labs and lecture halls.',
    departments: ['Electrical Engineering', 'Computer Engineering', 'Mechanical Engineering'],
    image: null,
  },
  {
    id: 'gateway',
    ...
    description: 'Main UCI bus and shuttle hub connecting campus to Irvine and surrounding areas.',
    departments: [],
    image: null,
  },
  {
    ...
    lng: -117.8461,
    hours: '24/7',
    description: 'Family and graduate student housing community.',
    departments: [],
    image: null,
  },
];
...
export const PARKING_LOTS = [
  { id: 'ps1', name: 'Parking Structure 1', type: 'Structure', available: 84, total: 400, permit: 'A, B', lat: 33.6448, lng: -117.8391 },
  { id: 'ps4', name: 'Parking Structure 4', type: 'Structure', available: 12, total: 500, permit: 'A, B, S', lat: 33.6452, lng: -117.8388 },
  { id: 'mesa-lot', name: 'Mesa Court Lot', type: 'Surface', available: 200, total: 250, permit: 'P', lat: 33.6496, lng: -117.8449 },
  { id: 'anteater-lot', name: 'Anteater Parking Lot', type: 'Surface', available: 0, total: 180, permit: 'A', lat: 33.6440, lng: -117.8462 },
];
